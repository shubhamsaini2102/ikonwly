  ...
  return (
    ...
    <div className='w-[70%] py-14 px-10 '>
        <div className='bg-white shadow-[0_16px_50px_0px_rgba(0,0,0,0.1)] rounded-3xl p-10 '>
            ...
            <h4 className='text-2xl font-semibold text-bodycolor mb-4'>Consulting Preferences</h4>
           ...
           <div className='mb-4'>
            <h5 className='text-xl text-bodycolor font-semibold mb-3'>Your Preferred Pricing for each type of Consultation (Euros):</h5>
           ...
           <div className='mb-4'>
            <h5 className='text-xl text-bodycolor font-semibold mb-3'>Select your preferred consulting services (Minimum 5):</h5>
           ...
           <div className='mb-4'>
            <h5 className='text-xl text-bodycolor font-semibold mb-3'>Other Services on your mind</h5>
