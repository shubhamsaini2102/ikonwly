        ...
        <div className='flex pt-[40px]'>
          <div className='relative w-[67%]'>
            ...
            <div className='mt-[20px] shadow-[0_0px_60px_-9px_rgba(0,0,0,0.1)] rounded-[40px] px-[45px] py-[45px]'>
              ...
              <h4 className='text-[#1B1B1B] text-[32px] font-[600] flex items-center justify-between mb-[10px] mt-[20px]'>Services </h4>
              <div className="border border-dashed border-[#ddd] rounded-[24px] mb-4 px-[10px] py-[10px]">
                <div className="flex items-center justify-between p-4 cursor-pointer" onClick={toggleAccordion}>
                  <div className='text-[20px] font-[500]'>Career Consultation</div>
                ...
                {isOne && <div className="p-4 pt-[0]">
                  <ul className='flex flex-wrap'>
                    <li className='flex gap-x-1 mb-[12px] w-auto bg-[#fff] items-center shadow-[0_0px_60px_-9px_rgba(0,0,0,0.1)] rounded-[64px] px-[25px] py-[20px] text-[16px] text-[#1B1B1B] font-[400] '> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Resume and Cover Letter Crafting and Review</li>
                    <li className='flex gap-x-1 mb-[12px] w-auto bg-[#fff] items-center shadow-[0_0px_60px_-9px_rgba(0,0,0,0.1)] rounded-[64px] px-[25px] py-[20px] text-[16px] text-[#1B1B1B] font-[400] '> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Job Search Strategies and Personalized Action Plans</li>
                    <li className='flex gap-x-1 mb-[12px] mr-[15px] w-auto bg-[#fff] items-center shadow-[0_0px_60px_-9px_rgba(0,0,0,0.1)] rounded-[64px] px-[25px] py-[20px] text-[16px] text-[#1B1B1B] font-[400] '> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Career Transition Assistance</li>
                    <li className='flex gap-x-1 mb-[12px] w-auto bg-[#fff] items-center shadow-[0_0px_60px_-9px_rgba(0,0,0,0.1)] rounded-[64px] px-[25px] py-[20px] text-[16px] text-[#1B1B1B] font-[400] '><Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Individual Interview Coaching</li>
                  </ul>
                </div>}
              </div>
              <div className="border border-dashed border-[#ddd] rounded-[24px] mb-4 px-[10px] py-[10px]">
                <div className="flex items-center justify-between p-4 cursor-pointer" onClick={toggleAccordionOne}>
                  <div className='text-[20px] font-[500]'>Education Consultation</div>
              ...
              <div className="border border-dashed border-[#ddd] rounded-[24px] mb-4 px-[10px] py-[10px]">
                <div className="flex items-center justify-between p-4 cursor-pointer" onClick={toggleAccordionTwo}>
                  <div className='text-[20px] font-[500]'>Skill Development</div>
