        ...
        <div className='flex max-mobile:flex-wrap'>
            ...
            <div className='w-[70%] py-14 px-10 max-ippad:w-[65%] max-ippadpro:w-[60%] max-mobile:w-full max-mobile:px-7 max-mobile:py-7 max-mobileland:p-4'>
                <div className='bg-white shadow-[0_16px_50px_0px_rgba(0,0,0,0.1)] rounded-3xl p-10 max-mobile:p-6 max-mobileland:p-4'>
                    ...
                    <h4 className='text-2xl font-semibold text-bodycolor mb-4 max-mobileland:text-1xl'>Headshot</h4>
                    ...
                    <div className="border border-[#ddd] rounded-3xl mb-4 px-3 py-3 max-mobile:p-0">
                        ...
                        {isOne && <div className="p-4 pt-[0]">
                            <ul className='flex flex-wrap'>
                                <li className='flex gap-x-1 mb-3 w-full items-center text-base text-bodycolor font-regular max-mobileland:text-sm'> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> High resolution. 72 ppi and 1300 x 700 pixels</li>
                                <li className='flex gap-x-1 mb-3 w-full items-center text-base text-bodycolor font-regular max-mobileland:text-sm'> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Clean, simple background and composition</li>
                                <li className='flex gap-x-1 w-full items-center text-base text-bodycolor font-regular max-mobileland:text-sm'> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> A well-lit environment</li>
                            </ul>
                        </div>}
                    </div>
                    <h4 className='text-2xl font-semibold text-bodycolor mb-4 max-mobileland:text-1xl'>Tagline <span className='text-[#FF0000]'>*</span></h4>
                    <p className='text-sm font-regular leading-6 border border-[#ddd] rounded-full py-2 px-6 text-[#0000004a] mb-4 max-mobileland:rounded-md'>Examples: Innovative EdTech Enthusiast: Transforming Career Trajectories with Advanced<br className='max-ippadpro:hidden' /> Technology and Education Strategies."_</p>
                    <div className="border border-[#ddd] rounded-3xl mb-4 px-3 py-3 max-mobileland:p-0">
                        ...
                        {isTow && <div className="p-4 pt-[0]">
                            <ul className='flex flex-wrap'>
                                <li className='flex gap-x-1 mb-3 w-full items-center text-base text-bodycolor font-regular max-mobileland:text-sm'> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Clarity and Conciseness</li>
                                <li className='flex gap-x-1 mb-3 w-full items-center text-base text-bodycolor font-regular max-mobileland:text-sm'> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> CInclusion of Relevant Keywords</li>
                                <li className='flex gap-x-1 w-full items-center text-base text-bodycolor font-regular max-mobileland:text-sm'> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Highlighting Unique Qualities</li>
                            </ul>
                        </div>}
                    </div>
