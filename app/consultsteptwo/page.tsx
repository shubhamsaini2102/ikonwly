  ...
  return (
    ...
    <div className='w-[70%] py-14 px-10 '>
        <div className='bg-white shadow-[0_16px_50px_0px_rgba(0,0,0,0.1)] rounded-3xl p-10 '>
            ...
            <h4 className='text-2xl font-semibold text-bodycolor mb-4'>About You <span className='text-[#FF0000]'>*</span></h4>
           <div className='mb-3'>
            ...
            <div className="border border-[#ddd] rounded-3xl mb-4 px-3 py-3">
                ...
                {isOne && <div className="p-4 pt-[0]">
                    <ul className='flex flex-wrap'>
                        <li className='flex gap-x-1 mb-3 w-full items-center text-base text-bodycolor font-regular '> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Clear and to the point</li>
                        <li className='flex gap-x-1 mb-3 w-full items-center text-base text-bodycolor font-regular '> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Mentions Certifications you've earned</li>
                        <li className='flex gap-x-1 mb-3 w-full items-center text-base text-bodycolor font-regular '> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Identifies unique programs or tools you work with</li>
                        <li className='flex gap-x-1 mb-3 w-full items-center text-base text-bodycolor font-regular '> <Image className="" src="/assets/images/verify.png" width={20} height={20} alt="" /> Highlights if you've had Fortune 1000 clients</li>
            ...
            <h4 className='text-2xl font-semibold text-bodycolor mb-4'>Industries <span className='text-[#FF0000]'>*</span></h4>
